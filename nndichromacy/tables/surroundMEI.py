...
class SurroundMEITemplateMixin:
    definition = """
    # contains maximally exciting images (SurroundMEIs)
...
class SurroundMEI(SurroundMEITemplateMixin, dj.Computed):
    ...
    seed_table = MEISeed
    mask_table = MEIThresholdMask # for mask that cover center
    mei_table = MEI # for center MEI together with 'SurrMEIRelateHash'
